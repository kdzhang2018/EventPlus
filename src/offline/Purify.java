...
public class Purify {
	public static void main(String[] args) {
		...
		MongoDatabase db = mongoClient.getDatabase(MongoDBUtil.DB_NAME);
                             // “/User/xxx/Downloads”
		String fileName = "/Users/kaidizhang/Downloads/tomcat_log.txt";
		...
		try {
			...
			while ((line = bufferedReader.readLine()) != null) {
				// Sample input: 
				// 73.223.210.212 - - [19/Aug/2017:22:00:24 +0000] "GET /EventPlus/history?user_id=1111 HTTP/1.1" 200 11410
